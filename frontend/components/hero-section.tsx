...
export default function HeroSection() {
  ...
  // Phase 1: Shrink Portrait (0% -> 30%)
  // Maps scroll 0-0.30 to scale 1-0
  const scale = useTransform(smoothProgress, [0, 0.30], [1, 0])

  // Phase 2: Text Parallax (0% -> 25%)
  ...
  const exitY = useTransform(smoothProgress, [0.4, 1], ["0%", "-100%"])
  const exitOpacity = useTransform(smoothProgress, [0.5, 1], [1, 0])

  return (
    <section ref={containerRef} className="relative h-[200vh] bg-[#1a1f1a]">
